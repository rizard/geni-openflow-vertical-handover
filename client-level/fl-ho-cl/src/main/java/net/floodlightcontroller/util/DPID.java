...
/**
 * The class representing DPID's. Based on class DPID in net.floodlightcontroller.util package
 *
...
public class DPID {
    ...
    /**
     * Returns the length of the {@code DPID}.
     * @return the length of the {@code DPID}.
     */
    public int length() {
    ...
    /**
     * Returns the value of the {@code DPID} as a {@code byte} array.
    ...
    /**
     * Returns the value of the {@code DPID} as a {@code long}.
